...
Support for additional formatters is enabled through the [developer API](development.md).
 ...
 * **`fix`** *(optional)* - The action to perform if the check fails. Repolinter can perform any action listed under [fixes documentation](./fixes.md).
